...
ff dw "WHICH TYPE YOU WANT?PLEASE SELECT:$"
f1 dw "WHICH PRODUCT DO YOU WANT? PLEASE SELECT:$"
f3 dw "1.BUY PRODUCT   2.RENT PRODUCT $"
f4 dw "1.SAREE RENT per/day 1(dollar)   2.SHEROWANI RENT per/day 3(dollar) $"
f5 dw "1.SHIRT PRICE 3(dollar)   2.PANT PRICE 3(dollar) $"
f6 dw "QUANTITY(1-3):$"
f7 dw "TOTAL PRICE:$"
f8 dw "############   THANK YOU   #########$" 
f9 dw " PRESS M TO BUY MORE $"
